...
function WithVoxel({ slide, children }) {
  ...
  const fadeStyle = {
    maskImage: 'radial-gradient(ellipse 70% 60% at center 60%, black 30%, transparent 100%)',
    WebkitMaskImage: 'radial-gradient(ellipse 70% 60% at center 60%, black 30%, transparent 100%)',
  };

  // Title and Section slides: voxel as background, content overlay
  if (slide.type === 'title' || slide.type === 'section') {
    return (
      <div className="relative w-full h-[75vh]">
        <div className="absolute inset-0 opacity-30" style={fadeStyle}>
