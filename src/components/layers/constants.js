...
export const SCHEMA_NODES = [
  ...
  },
  {
    ...
    details: 'Using ComfyUI for audio pipelines allows for complex mixing, stem separation, and precise control that web generators lack.',
    connections: [],
    tools: ['ComfyUI Audio'],
    timeEstimate: 'Hard',
    x: 4, y: 3,
    toolDetails: [
      { name: 'ComfyUI', url: 'https://github.com/comfyanonymous/ComfyUI', category: 'Framework', description: 'Node-based visual programming for GenAI.', bestFor: 'Complex pipelines, mixing, offline work.', pros: 'Free, Infinite control, Multi-modal (AV).', cons: 'High technical barrier, fragile pipelines.' }
    ]
  },
  {
    id: 'infra',
