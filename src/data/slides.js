...

  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Что делать, когда что-то сломалось? Заглушка, retry, или падать с ошибкой?",
      },
      {
        num: "7",
...

{
  ...
  blockTitle: "Agent Economy",
  type: "content",
  title: "HR для агентов",
  content: "Агенты — это не чат. Это сотрудники. Им нужен онбординг, как людям.",
  items: [
    "Каждому агенту — роль и зона ответственности (дизайнер, QA, копирайтер)",
    "Папка с описанием всех агентов в команде — чтобы каждый знал, кто ещё есть",
    "Новый агент = новый сотрудник: дать контекст, познакомить с коллегами",
    "Спецификация агента: что умеет, к чему имеет доступ, чего НЕ делает",
    "Агенты могут делегировать задачи другим агентам — если знают про них",
  ],
  note: "В Obsidian или любой базе знаний: папка /agents с карточкой на каждого. Это и есть HR для AI-команды.",
},

{
  ...
  content: "Тема агентов развивается быстрее всего. Ссылки для самостоятельного изучения:",
  items: [
    { name: "Anthropic: Building Effective Agents", url: "https://anthropic.com/engineering/building-effective-agents" },
    { name: "Google: Agent White Paper", url: "https://cloud.google.com/transform/agent-white-paper" },
    { name: "Choosing an Agent Framework (2025)", url: "https://langflow.org/blog/the-complete-guide-to-choosing-an-ai-agent-framework-in-2025" },
    { name: "Agent-to-Agent (A2A) Protocol", url: "https://google.github.io/A2A" },
  ],
},
  ...
  items: [
    {
      ...
      desc: "Kling — понимает физику, Elements: несколько картинок → одна сцена. До 2 мин (платно).",
      hours: "Вход",
    },
    {
      level: "02",
